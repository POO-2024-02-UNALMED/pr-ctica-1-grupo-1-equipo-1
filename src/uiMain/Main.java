        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    ArrayList<Ruta> rutasDisponibles = Ruta.filtrarRutas(origen, destino);
                    ...
                    pasajero.comprarTiquete(rutaSeleccionada, tipoAsiento, rutasDisponibles);
                    break;
                case 3:
                ...
                case 4: // Funcionalidad 3 Reembolso de Tiquete
                    ...
                    /**
                     * if(mensaje3.equals("El asiento liberado puede ser reservado nuevamente, Su
                     * reembolso sigue en proceso")){
                     * 
                     * }
                     * //Sigue la ejecucion
                     */
